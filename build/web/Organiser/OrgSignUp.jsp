<%-- 
    Document   : OrgSignUp
    Created on : 11 Aug, 2023, 7:11:47 PM
    Author     : admin
--%>
...
<html>
  <head>
    ...
    <link href="http://localhost:8084/Tour/Organiser/OrgSignUpcss.css" rel="stylesheet" />
    <link
    ...
    <div class="signin">
      ...
      <div class="form-section">
        ...
        name="btn"><p class="active" style="align-items: center;font-size: 1.75rem; padding-top: 5px;">Sign Up</p></button>
          ...
          <p style="margin-left:60px;margin-top: 10px;">Already a member <a href="http://localhost:8084/Tour/Organiser/OrgLogin.jsp" style="color: #7e7d7d;
