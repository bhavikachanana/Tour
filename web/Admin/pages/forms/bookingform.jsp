<%-- 
    ...
    Created on : 29 Jul, 2023, 11:57:38 AM
    Author     : bhavi
--%>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#"> User Bookings </a></li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Manage Facts
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <label for="exampleInputName2">Organizer ID</label>
                        ...
                        <input type="text" class="form-control" id="exampleInputName3" placeholder="Name">
                         ...
                         <div class="form-group">
                        <label for="exampleInputName4">Transport</label>
                        ...
                        <input type="text" class="form-control" id="exampleInputName4" placeholder="Name">
                         ...
                         <div class="form-group">
                        <label for="exampleInputName2">Local Transport</label>
