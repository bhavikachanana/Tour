<%-- 
    Document   : OrgHeader
    Created on : 11 Aug, 2023, 6:47:59 PM
    Author     : admin
--%>
        ...
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
          <div class="d-inline-flex align-items-center" style="height: 45px">
            <p class="preview-subject mb-1">Welcome 
                                ...
                                <%=session.getAttribute("Organiser").toString()%>
                                </p>
                                 <%}
                                catch(Exception ex)
                                {
      ...
      >
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav ms-auto py-0">
            ...
            <a href="http://localhost:8084/Tour/Organiser/Organizers_from.jsp" class="nav-item nav-link">Add Plan</a>
          </div>
            <a href="http://localhost:8084/Tour/OrgServlet?btn=logout" class="btn btn-primary rounded-pill py-2 px-4">Log Out</a>
        </div>
      </nav>
    </div>
    </body>
